...
(
    ...
    'palettes' => array
    (
        '__selector__' => array('type', 'cssFilter', 'addLanguage', 'addTip', 'limitPages', 'limitCount'),
        'default' => '{tag_legend},tag,description;{target_legend},type',
        'internal' => '{tag_legend},tag,description;{target_legend},type,page,selflink,popup;{limit_legend:hide},cssFilter,limitCount,limitPages;{language_legend:hide},addLanguage;{tips_legend:hide},addTip;{expert_legend:hide},casesensitive,words,cssID,regex;{published_legend},published,start,stop',
        'external' => '{tag_legend},tag,description;{target_legend},type,url,popup;{limit_legend:hide},cssFilter,limitCount,limitPages;{language_legend:hide},addLanguage;{tips_legend:hide},addTip;{expert_legend:hide},casesensitive,words,cssID,regex;{published_legend},published,start,stop',
        'none' => '{tag_legend},tag,description;{target_legend},type;{limit_legend:hide},cssFilter,limitCount,limitPages;{language_legend:hide},addLanguage;{tips_legend:hide},addTip;{expert_legend:hide},casesensitive,words,cssID,regex;{published_legend},published,start,stop',
    ),
    ...
    (
        ...
        'limitCount' => array
        (
            'label' => &$GLOBALS['TL_LANG']['tl_autolink']['limitCount'],
            'exclude' => true,
            'inputType' => 'checkbox',
            'eval' => array('submitOnChange' => true),
        ),
        'count' => array
        (
            'label' => &$GLOBALS['TL_LANG']['tl_autolink']['count'],
            'exclude' => true,
            'inputType' => 'text',
